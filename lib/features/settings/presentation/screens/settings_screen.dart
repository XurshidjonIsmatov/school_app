...
import 'package:school_app/features/settings/presentation/screens/template_settings_screen.dart';
import 'package:school_app/features/auth/presentation/screens/change_pin_screen.dart';
...
import 'package:school_app/features/settings/presentation/screens/sent_messages_log_screen.dart';
...
class _SettingsScreenState extends State<SettingsScreen> {
  ...
  Future<void> _loadSettings() async {
    ...
    setState(() {
      ...
      _isBotConfigured = token != null && token.isNotEmpty;
      _isLoading = false;
    });
  }

  Future<void> _deleteBotSettings() async {
    final storage = context.read<SecureStorageService>();
    ...
    setState(() {
      ...
      _isBotConfigured = false;
    });
    if (mounted) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('Bot sozlamalari o\'chirildi')),
      );
    }
  }
  ...
  void _confirmDeleteBot() {
    showDialog(
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: const Text(
          'Haqiqatan ham bot sozlamalarini o\'chirmoqchimisiz? Yangi bot ulash uchun avval eskisini o\'chirishingiz kerak.',
        ),
        actions: [
          TextButton(
