...
class StudentProvider extends ChangeNotifier {
  ...
  Future<void> addStudent(
    ...
    if (id > 0) {
      ...
      if (botToken != null && adminChatId != null) {
        _addMessageToQueue(student, adminChatId);
      }
    }
  }
  ...
  Future<void> saveAttendance({
    ...
    if (botToken != null && adminChatId != null && customMessage != null) {
      final tgService = TelegramService(botToken: botToken);
      await tgService.sendMessage(adminChatId, customMessage);
    }
  }
  ...
  Future<void> sendMonthlyPaymentReport(
    ...
    if (botToken != null && adminChatId != null) {
      final tgService = TelegramService(botToken: botToken);
      await tgService.sendMessage(adminChatId, report);
    }
  }
  ...
  Future<void> sendDebtReminderTelegram({
    ...
    if (botToken != null && adminChatId != null) {
      final tgService = TelegramService(botToken: botToken);
      await tgService.sendMessage(adminChatId, message);
    }
  }
